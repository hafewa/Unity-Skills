...
│  │ (Multi-Instance)│  │(Auto-Undo)  │  │  (444 Skills)   │  │
│  └─────────────────┘  └─────────────┘  └─────────────────┘  │
│           ↓                  ↓                              │
│  ┌─────────────────┐  ┌─────────────────────────────────┐   │
...
│           ├── UIToolkitSkills.cs      # UI Toolkit UXML/USS/UIDocument (13 skills)
...
│           └── ... (38 个 *Skills.cs 文件, 共 444 Skills)
│
...
| **UI Toolkit** | 13 | UXML/USS文件管理/UIDocument/PanelSettings/模板生成/结构检查/批量创建 |
