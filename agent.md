...
> 通过 REST API 让 AI 直接控制 Unity 编辑器。542 个 REST Skills + 13 个 Advisory 模块。
...
│   │   └── *Skills.cs × 41             # 功能模块 (共 542 Skills)
